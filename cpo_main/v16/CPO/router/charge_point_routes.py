from CPO import schemas, models, oauth2
from CPO.database import get_db
from sqlalchemy.orm import Session
from CPO.hashing import Hash
from fastapi import APIRouter, Depends, WebSocket, WebSocketDisconnect
from cpo_class import ChargePoint
from CPO.classes import WebsocketAdapter
...
@router.get("/chargepoints/{charge_point_id}/trigger")

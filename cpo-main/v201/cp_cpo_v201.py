...
class ChargePoint(cp):
        ...
        if authorize:
            ...
            return call_result.AuthorizePayload(
                id_tag_info={
                    ...
                    'status': AuthorizationStatusType.expired
                }
            )
    ...
    async def on_meter_values(self, evse_id, meter_values):
        ...
        await http_cpo.CentralSystem.meter_values(evse_id, meter_values)
        print(f'{self.id} recieved MeterValue')
        return call_result.MeterValuesPayload()


    async def send_request_start_transaction(self, id_token: dict, remote_start_id: int):
        """Send a start transaction request.
        Not tested"""
        print("Start remote transaction request")
        return await self.call(call.StartTransactionPayload(
    ...
    async def send_request_stop_transaction(self, transaction_id: str):
        ...
        return await self.call(call.StopTransactionPayload(
